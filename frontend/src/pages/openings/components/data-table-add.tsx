...
export default function AddProject() {
  const initialFormState = {
    clientName: '',
    projectName: '',
    openings: [] as { skills: string[], count: string }[], // Array of objects with skills and opening count (as text)
  };

  const [formData, setFormData] = useState(initialFormState);
  const [selectedSkills, setSelectedSkills] = useState<string[]>([]); // Array to store selected skills
  const [openingCount, setOpeningCount] = useState(''); // Store the number of openings for the selected skills as text

  // Handle dropdown selection for client and project
  ...
  // Handle the selection of multiple skills
  ...
  // Add the selected skills and opening count to the openings array
  const addOpening = () => {
    // Check if skills and openings are empty
    ...
    // Clear the selected skills and count after adding
    setSelectedSkills([]);
    setOpeningCount('');
  };

  // Handle form submission: It will submit without any checks and show an alert
  // const handleSubmit = (e: { preventDefault: () => void }) => {
  //     e.preventDefault();

  //     // Alert to confirm the successful submission
  //     alert('Project added successfully!');

  //     console.log('Submitted Openings:', formData.openings);
  //     // You can send 'formData.openings' to the backend here

  //     // Reset form to the initial state after submission
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 border border-gray-300 dark:border-gray-600">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-black dark:text-white">Selected skills: {selectedSkills.join(', ') || 'None'}</p>
                    </div>
                  </td>
                </tr>
                ...
                {/* Add Opening Button Aligned to the Left */}
                <tr>
